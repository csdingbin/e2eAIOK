...
def main(args):
    ...
    parameters = model.get_sampled_params_numel(config)
    print("model parameters size: {}".format(parameters))
    ...
    if args.eval:
        test_stats = evaluate(criterion, data_loader_val, model, device,  mode = args.mode)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        test_stats = evaluate(criterion, data_loader_val, model, device)
        print(f"Accuracy of the network on the {len(dataset_val)} test images: {test_stats['acc1']:.1f}%")
