...
def do_compute_nas_score_prev(model_type, model, resolution, batch_size, mixup_gamma, expressivity_weight=0, complexity_weight=0, diversity_weight=0, saliency_weight=0, latency_weight=0):
    dtype = torch.float32
    ...
    return nas_score, nas_score, latency
