...
params_dict = {
    'imagenet': {
        'train_dir': os.path.expanduser('/mnt/DP_disk6/tmp/train/'),
        'val_dir': os.path.expanduser('/mnt/DP_disk6/tmp/val/'),
    ...
    'cifar100': {
        'train_dir': os.path.expanduser('/mnt/DP_disk7/dataset/cifar/cifar-100-python'),
        'val_dir': os.path.expanduser('/mnt/DP_disk7/dataset/cifar/cifar-100-python'),
        'num_train_samples': 50000,
        'num_val_samples': 10000,
        'num_classes': 100,
    },
