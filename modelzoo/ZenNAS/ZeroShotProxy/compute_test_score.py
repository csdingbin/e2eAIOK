...
def do_compute_nas_score(gpu, model, resolution, batch_size, mixup_gamma):
    ...
    # print(F"mixup_input size:{mixup_input.size()}")

    grads_abs_list = compute_synflow_per_weight(net=model, inputs=input, inputs2=mixup_input, mode='')
    # grads_abs_list2 = compute_synflow_per_weight(net=model, inputs=mixup_input, mode='')
